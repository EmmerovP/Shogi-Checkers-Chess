...
namespace GeneralBoardGames
{
    public class PiecesNumbers
    {
        ...
        public static Dictionary<string, int> getMoveName = new Dictionary<string, int>()
        {
            ...
            { "Dopředu nekonečno", 9 },
            { "ForwardInfinity", 9 },
            { "Dopředu vpravo nekonečno", 10 },
            { "ForwardRightInfinity", 10 },
            { "Vpravo nekonečno", 11 },
            { "RightInfinity", 11 },
            { "Dozadu vpravo nekonečno", 12 },
            { "BackRightInfinity", 12 },
            { "Dozadu nekonečno", 13 },
            { "BackInfinity", 13 },
            { "Dozadu vlevo nekonečno", 14 },
            { "BackLeftInfinity", 14 },
            { "Vlevo nekonečno", 15 },
            { "LeftInfinity", 15 },
            { "Dopředu vlevo nekonečno", 16 },
            { "ForwardLeftInfinity", 16 },
            { "Kůň", 17 },
            { "Horse", 17 },
            { "Kůň dopředu", 18 },
            { "HorseForward", 18 },
